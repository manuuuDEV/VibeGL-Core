...
### CDN / Standalone HTML
```html
<script src="https://unpkg.com/@vibe-gl/core/dist/vibe-gl-core.global.js"></script>
```

## ⚛️ Next.js App Router (RSC) Setup

VibeGL-Core components are client-side by nature but correctly use `"use client"` boundaries to prevent hydration mismatches.
...
const Scene = dynamic(() => import('./Scene'), { ssr: false, loading: () => <div>Loading 3D...</div> });
